...
manage_tcp_echo_resources() {
  ...
  if [ "$action" == "apply" ]; then
    ...
    kubectl -n $NS delete -f https://gist.githubusercontent.com/danehans/8081ade20ac03153c5d4625e64c419bf/raw/5404e2ad11d8bdd6e34b1d18effa1fb98401e1e1/tcp_echo.yaml

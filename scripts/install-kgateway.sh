...
HELM_CHART=${HELM_CHART:-"https://github.com/danehans/toolbox/raw/refs/heads/main/charts/9e39f8d1d6-kgateway-1.0.1-dev.tgz"}
...
HELM_CRD_CHART=${HELM_CRD_CHART:-"https://github.com/danehans/toolbox/raw/refs/heads/main/charts/9e39f8d1d6-kgateway-crds-1.0.1-dev.tgz"}
